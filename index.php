    		...
    		<div class="row">
    			<div class="col-md-6">Education
					...
					<div class="resume-wrap ftco-animate">
    					...
    					<h2>Integrated preparatory cycle in computer science</h2>
    					<span class="position">ITBS-IT Business School University</span>
    				</div>
					<div class="resume-wrap ftco-animate">
    				...
    				<div class="resume-wrap ftco-animate">
    					...
    					<span class="position">Development of a banking dashboard:
Contribution to the development of a dashboard using Flask and Angular technologies.</span>
    				</div>
  ...
  <div class="container">
    ...
    <section class="ftco-section ftco-project" id="certifications-section">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
		   ...
		   <div class="row">
			<div class="col-md-6">
				<a href="certifs/Crash Course on Python.pdf" target="_blank">
					<div class="resume-wrap ftco-animate">
						<img src="certifs/certif1.png" style="width: 100%; height: auto;">
					</div>
				</a>
			</div>
			<div class="col-md-6">
				<a href="certifs/Hands-on Introduction to Linux Commands and.pdf" target="_blank">
					<div class="resume-wrap ftco-animate">
						<img src="certifs/certif2.png" style="width: 100%; height: auto;">
					</div>
				</a>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<a href="certifs/Building Web Applications in PHP.pdf" target="_blank">
					<div class="resume-wrap ftco-animate">
						<img src="certifs/certif3.png" style="width: 100%; height: auto;">
					</div>
				</a>
			</div>
			<div class="col-md-6">
				<a href="certifs/Web Applications for.pdf" target="_blank">
					<div class="resume-wrap ftco-animate">
						<img src="certifs/certif4.png" style="width: 100%; height: auto;">
					</div>
				</a>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<a href="certifs/Python 3 Programming.pdf" target="_blank">
					<div class="resume-wrap ftco-animate">
						<img src="certifs/certif5.png" style="width: 100%; height: auto;">
					</div>
				</a>
			</div>
			<div class="col-md-6">
				<a href="certifs/Improve Your Java Code Using Amazon CodeGuru.pdf" target="_blank">
					<div class="resume-wrap ftco-animate">
						<img src="certifs/certif6.png" style="width: 100%; height: auto;">
					</div>
				</a>
			</div>
		</div>
    	...
    	<div class="container">
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
             ...
             <span class="oi oi-plus"></span><strong class="number" data-number="13">0</strong>
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text">
			  <span class="oi oi-plus"></span>   <strong class="number" data-number="7">0</strong>
          ...
          <div class="col-md d-flex justify-content-center counter-wrap ftco-animate">
            <div class="block-18">
              <div class="text">
			  <span class="oi oi-plus"></span>  <strong class="number" data-number="3">0</strong>
                <span>Awards</span>
              </div>
            </div>
          </div>
    ...
    <section class="ftco-section ftco-hireme img margin-top" style="background-image: url(images/img.png)">
			<div class="container">
    ...
    <section class="ftco-section contact-section ftco-no-pb" id="contact-section">
      <div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <p>If you have any questions or requests, please do not hesitate to contact us. We're here to help. Use our contact form or send us an e-mail. We will reply to your message as soon as possible. Thank you for your interest.</p>
          </div>
        </div>
        ...
        <div class="row d-flex contact-info mb-5">
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p>Ibn Batouta Street, Dar Chabane El Fehri, Nabeul, Tunis</p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
        ...
        <div class="row no-gutters block-9">
		  ...
		  <form action="process-form.php" class="bg-light p-4 p-md-5 contact-form" method="post">
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <p>Stay updated with the latest news by following us on Social Media,including LinkedIn!</p>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#resume-section" class="nav-link"><span class="icon-long-arrow-right mr-2"></span>Resume</a></li>
				<li><a href="#skills-section" class="nav-link"><span class="icon-long-arrow-right mr-2"></span>Skills</a></li>
                <li><a href="#certifications-section" class="nav-link"><span class="icon-long-arrow-right mr-2"></span>Certifications</a></li>
              </ul>
            </div>
          </div>
